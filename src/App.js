    ...
    return (
        <div className="bg-gray-900 min-h-screen flex flex-col items-center justify-center p-4">
            <div className="w-full max-w-md bg-gray-800 p-8 rounded-2xl shadow-2xl">
                ...
                <div className="mt-4">
                    <button onClick={handleGoogleSignIn} className="w-full bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-4 rounded-lg transition flex items-center justify-center space-x-2">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.54-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#4285F4"/><path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.64-2.23 1.05-3.71 1.05-2.86 0-5.29-1.93-6.19-4.53H2.96v2.89C4.81 20.75 8.28 23 12 23z" fill="#34A853"/><path d="M5.81 14.09c-.27-1.01-.42-2.09-.42-3.18s.15-2.17.42-3.18V4.72H2.96C1.09 6.67 0 9.24 0 12s1.09 5.33 2.96 7.28l2.85-2.19z" fill="#FBBC05"/><path d="M12 4.72c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 1.26 14.97 0 12 0 8.28 0 4.81 2.25 2.96 4.72L5.81 7.61c.9-2.6 3.33-4.53 6.19-4.53z" fill="#EA4335"/></svg>
                        Sign in with Google
                    </button>
                </div>
